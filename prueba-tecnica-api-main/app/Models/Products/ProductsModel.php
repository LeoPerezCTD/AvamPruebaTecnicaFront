...
class ProductsModel extends Model{
    ...
    protected $identificator   = "product_id";
    protected $creator         = "product_created_by";
    protected $modifier        = "product_modified_by";
    protected $modifiedAt      = "product_modified_at";
    protected $active          = "product_active";
    protected $delete          = "product_delete";
        ...
        if ($id == null){
			try{
				$sql = "SELECT
                        ...
                        -- created_by
                        inner join users us
                            on pr.product_created_by = us.user_id

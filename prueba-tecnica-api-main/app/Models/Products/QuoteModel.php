...
class QuoteModel extends Model{
    ...
    protected $identificator   = "quote_id";
    protected $creator         = "quote_created_by";
    protected $modifier        = "quote_modified_by";
    protected $modifiedAt      = "quote_modified_at";
    protected $active          = "quote_active";
    protected $delete          = "quote_delete";
	...
	public function insertDataWeb($form,$user){
		try{
			DB::beginTransaction();
			$quoteDetails = null;
			if(isset($form->quote_detail)){
				$quoteDetails = $form->quote_detail;
				unset($form->quote_detail);
			}
			...
			if(!isset($quote_detail)){
				$quoteDetailModel = new QuoteDetailModel();
				// insert in quote details.
				foreach($quoteDetails as $values){
					$values->quote_id = $quote_id;
					$result = $quoteDetailModel->insertData($values,$user);
					if($result === false){
						DB::rollBack();
            			return false;
					}
